...
namespace Unity {
    ...
    struct Matrix3x3;   // Forward declaration
    
    inline void QuaternionToMatrix(const ::Unity::Quaternion& q, struct Matrix4x4& m);
    ...
    struct Matrix4x4 {
        ...
        inline Matrix4x4(const ::Unity::Matrix3x3 &other) {
        ...
        inline Matrix4x4& operator=(const ::Unity::Matrix3x3& other) {
            m_Data[0] = other.m_Data[0];
            m_Data[1] = other.m_Data[1];
            m_Data[2] = other.m_Data[2];
            m_Data[3] = 0.0F;
        ...
        [[nodiscard]] inline ::Unity::Quaternion rotation() const {
